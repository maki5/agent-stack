...
This skill provides GitHub integration using the official `gh` CLI tool.
...
The GitHub workflow skill uses the official `gh` CLI for all GitHub operations.

**Quick start:**
1. Install: `brew install gh` (or equivalent for your OS)
2. Authenticate: `gh auth login`
3. Verify: `gh auth status`
4. Read: `gh issue list --repo OWNER/REPO`
5. Write: `gh issue create`, `gh pr create`, etc.
